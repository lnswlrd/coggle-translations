...
# Login Page /login
login-heading = Увайсці ў Coggle:
index-loginwithgoogle = Увайсці праз Google
index-signinwithapple = Увайсці праз Apple

login-title = Coggle - Увайдзіце, каб пачаць стварэнне інтэлект-карт
...
login-colab = Ці магу я супрацоўнічаць з калегамі?
login-colab-a = Супрацоўнічайце і бачыце змены, якія ўносяць вашы калегі,
    імгненна па меры іх унясення! Запрашайце калег па электроннай пошце і кіруйце
    тым, хто можа ўносіць змены, у правым верхнім куце старонкі дыяграмы.

login-free = Ці бясплатны Coggle?
login-free2-a = Так, усё для стварэння выдатных інтэлектуальных карт - без
    абмежавання часу, супрацоўніцтва ў рэжыме рэальнага часу, без абмежавання
    памеру і многае іншае - бясплатна. <a data-l10n-name='pricing'>Абнаўленне для
    дадатковых магутных функцый</a> для прафесіяналаў і вялікіх каманд.
...
login-help = Дзе я магу атрымаць дапамогу або падтрымку?
login-help-a = Наведайце нашу базу ведаў па адрасе <a data-l10n-name='help'>coggle.help</a>, каб атрымаць шмат ілюстраваных даведнікаў, або напішыце нам па адрасе <a data-l10n-name="email">hello@coggle.it</a>.
